...
if __name__ == '__main__':
    ...
    for i, item in enumerate(raw_examples):
        ...
        for sent in sentences:
            ...
            print(labels)
    """
sentences_v1= ['深圳市沙头角保税区今后五年将充分发挥保税区的区位优势和政策优势，以高新技术产业为先导，积极调整产品结构，实施以转口贸易和仓储业为辅助的经营战略。', '把沙头角保税区建成按国际惯例运作、国内领先的特殊综合经济区域，使其成为该市外向型经济的快速增长点。']
深圳市沙头角保税区今后五年将充分发挥保税区的区位优势和政策优势，以高新技术产业为先导，积极调整产品结构，实施以转口贸易和仓储业为辅助的经营战略。
[('GPE', '深圳市', 0), ('GPE', '沙头角', 3), ('LOC', '保税区', 6), ('LOC', '保税区', 18)]
把沙头角保税区建成按国际惯例运作、国内领先的特殊综合经济区域，使其成为该市外向型经济的快速增长点。
[('GPE', '沙头角', 1), ('LOC', '保税区', 4)]
    """
